		...
		<div className="min-h-screen bg-brand-bg flex items-center justify-center px-4 py-12">
			<div className="w-full max-w-2xl">
				...
				<div className="text-center mb-8">
					...
					<h1 className="text-4xl font-bold text-[#dce1fb] mb-2">
						Register Your Organisation
					</h1>
					<p className="text-lg text-[#dce1fb]">
						Join MediScan NG and transform healthcare in your facility
					</p>
				</div>
				...
				<form
					...
					className="bg-brand-card rounded-3xl border p-6 sm:p-8 space-y-6"
				>
					{errors.submit && (
					...
					<div className="bg-[#151b2d] rounded-xl border border-brand-border text-brand-text placeholder-brand-text-muted p-4 space-y-3">
						...
						<p className="text-xs text-[#8c91a8]">
							You will start with a free 30-day trial. No payment information
							required at signup.
						</p>
					</div>
