            ...
            <div className="space-y-3 sm:space-y-4">
                {[
                    ...
                    <div key={stat.label} className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2 text-[#dce1fb]/40 min-w-0">
                            {stat.icon}
                            <span className="text-[10px] sm:text-xs truncate">{stat.label}</span>
                        </div>
                        <span className="text-[#dce1fb] text-sm font-semibold tabular-nums flex-shrink-0">{stat.value}</span>
                    </div>
                ))}
            </div>
        </div>
