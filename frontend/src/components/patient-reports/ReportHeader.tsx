		...
		<div className="glass-panel rounded-2xl p-6 mb-6 relative overflow-hidden group">
			<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
				...
				<div className="sm:text-right w-full sm:w-auto border-t sm:border-t-0 border-brand-border/30 pt-3 sm:pt-0">
					<p className="text-brand-text-muted text-[10px] font-bold uppercase tracking-wider mb-1">
						Report ID
					</p>
					<p className="text-brand-primary font-mono text-xs font-bold">
						{reportId}
					</p>
					<p className="text-brand-text-muted text-[11px] mt-1.5 font-medium">
						{reportDate}
					</p>
				</div>
			</div>
